<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="CulinaryDelight.About" %>

<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <hgroup class="title">
         <h1>A little bit of ourselves at Culinarydelight.info</h1>
    </hgroup>

    <article>
        <p>        
            We are a dedicated team of Certified Food Handlers, having obtained our Food Handler certificate from City of Toronto. Having our own online business was a thought we, as a bunch of friends had from the first day we met in the field of Food Service. We individually and as a team value the importance of Custome Satisfaction, the ultimate goal any physical or online business seek to achieve. Therefore, we have taken meticulous care to arrange our Authentic Menu Options in three distinct varieties, namely
            SRI LANKAN, GUJARATI &amp; THANDOORI.
        </p>
        <h6 style="background-color: #33CC33; color: #000000; font-weight: bold; text-decoration: underline">
            SRI LANKAN
...
The type of the hearth (t’onir) and the form of the tableware (made out of clay), made originally by Armenians, spread all over the South Caucasus, influencing the very nature of the dishes.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <aside>
        <h6>For anyone interested in preparing your own dishes similar to these authentic menus, once register and make an order for more than $25.00, we would send you the secret recipe for your order, to show our appreciation for your continued support.</h6>
        <p>        
            Use this area to provide additional information.
        </p>
        <ul>
            <li><a id="A1" runat="server" href="~/">Home</a></li>
           <li><a id="aboutLink" runat="server" href="~/About">About</a></li> 
