...
namespace SecurityLib
{
    public class SecureCard
    {
        ...
        private XmlDocument xmlCardData = null;
        ...
        public SecureCard(string newCardHolder, string newCardNumber, string newIssueDate, string newExpriyDate,
            string newIssueNumber, string newCardType)
        { 
            //construtor for use with decrypted data
            cardHolder = newCardHolder;
            cardNumber = newCardNumber;
            issueDate = newIssueDate;
            expiryDate = newExpriyDate;
